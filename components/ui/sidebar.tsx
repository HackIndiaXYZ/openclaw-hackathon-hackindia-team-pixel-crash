      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Button
            ...
            size="sm"
            className={cn(
              "h-7 w-7 rounded-md border border-border bg-background hover:bg-accent hover:text-accent-foreground",
              className,
            )}
            onClick={(event) => {
              onClick?.(event)
          ...
          >
            ...
            <div className="relative">
              {isMobile ? (
                ...
                <PanelLeft className="h-4 w-4 transition-transform duration-300 group-data-[state=collapsed]/sidebar-wrapper:rotate-180" />
              )}
            </div>
          </Button>
        </TooltipTrigger>
        <TooltipContent side="bottom" className="bg-background/95 backdrop-blur-sm border border-border/50">
          <div className="flex flex-col items-center gap-1">
            ...
            <kbd className="px-2 py-1 text-xs bg-muted rounded border">{isMobile ? "Tap" : "Ctrl+B"}</kbd>
          </div>
        </TooltipContent>
      </Tooltip>
    )
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <button
            ...
            {...props}
          >
            {/* Arrow icons with bounce animation */}
            <div className="relative flex items-center justify-center">
              {state === "expanded" ? (
                <div className="flex items-center gap-0.5">
                  <div className="w-1 h-1 bg-current rounded-full" />
                  <div className="w-0 h-0 border-t-2 border-b-2 border-r-4 border-transparent border-r-current" />
                </div>
              ) : (
                <div className="flex items-center gap-0.5">
        ...
        <TooltipContent side="right" className="bg-background/95 backdrop-blur-sm border border-border/50">
          <div className="flex flex-col items-center gap-1">
            <span className="font-medium">Toggle Sidebar</span>
